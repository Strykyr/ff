...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear,Resnet_LSTM,Resnet,LSTM,Attention_LSTM,Attention,BILSTM
...
class Intervention(nn.Module):
    def __init__(self, num_classes=4, embed_dim=4):
        super().__init__()
...
intervention_dict = {'11': 0, '12': 1, '13': 2}
